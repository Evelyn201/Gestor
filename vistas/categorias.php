 				...
 				<div class="row">
 					<div class="col-sm-4">
 						<span class="btn btn-primary" data-toggle="modal" data-target="#modalAgregaCategoria">
 							<span class="fas fs-plus-circle"></span>Agregar nueva categoria
 						</span>
 					</div> 					
 				</div>
 				<hr>
...
<div class="modal fade" id="modalActualizarCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btn CerrarUpdateCategoria">Cerrar</button>
        <button type="button" class="btn btn-warnig" id="btnActualizaCategoria">Actualizar</button>
      </div>
    </div>
  </div>
</div>
...
?>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#btnActializaCategoria').click(function(){
				actualizaCategoria();
			});
